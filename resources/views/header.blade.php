            ...
            <div class="menu-header">
                ...
                <div class="custom-nav" role="navigation">
                    ...
                    <ul class="nav-list right-end-btn">
                        ...
                        <li class="hidemobile"><a href="{{route('login')}}" class="btn-br bg-btn3 btshad-b2 lnk"><span class="circle"></span>Login  </a> </li>
        ...
        <div class="offcanvas-body">
            ...
            <div class="getintouchblock mt30">
                ...
                <div class="media mt15">
                    ...
                    <div class="media-body getintouchinfo">
                        <a href="tel:+91 70109 60294">+91 70109 60294 <span></span></a>
                ...
                <div class="media mt15">
                    ...
                    <div class="media-body getintouchinfo">
                        <a href="https://wa.me/+9170109 60294" target="_blank">+91 70109 60294 <span></span></a>
                ...
                <div class="media mt15">
                    ...
                    <div class="media-body getintouchinfo">
                        <a href="mailto:saisaravanapg@gmail.com" target="_blank">saisaravanapg@gmail.com
                ...
                <div class="media mt15">
                    ...
                    <div class="media-body getintouchinfo">
                        <a href="#">
                        Gate No. 4, Plot No. 4, near DLF Back Gate, Sri Lakshmi Nagar, Krishnaveni Nagar, Mugalivakkam, Chennai, Tamil Nadu 600116. <span>Visit Our Office</span></a>
                    </div>
                </div>
            </div>
            <div class="contact-data mt30">
                ...
                <div class="social-media-linkz mt10">
                    ...
                    <a href=""><img src="./img/download/google.png" width="18px"
                            alt=""></a>
