            ...
            <div class="col-lg-11">
                <div class="card shadow-lg p-4 ms-4">
                    ...
                    <form action="#" enctype="multipart/form-data" class="container">
                        ...
                        @if ($task->orderTaskAssign && $task->orderTaskAssign->orderExecutiveTask)
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        <textarea class="form-control" rows="4" readonly>{{ optional($task->orderTaskAssign->orderExecutiveTask)->remarks }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control fw-bold text-dark"
                                            value="{{ optional($task->orderTaskAssign->orderExecutiveTask)->geo_latitude }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control fw-bold text-dark"
                                            value="{{ optional($task->orderTaskAssign->orderExecutiveTask)->geo_longitude }}"
                                            readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center mt-5">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control"
                                        value="{{ optional($task->orderTaskAssign->orderExecutiveTask)->status }}" readonly>
                                </div>
                            </div>
                        @endif
                    </form>
                    ...
                    @if (session('role_name') === 'Superuser')
                        <form action="{{ route('order-reassign-executive') }}" method="POST">
                            @csrf
