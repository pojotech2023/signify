                    ...
                    <form action="" method="POST" enctype="multipart/form-data" class="container">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5">
                                <div class="form-group d-flex align-items-center gap-2">
                                    <input type="text" class="form-control fw-bold text-dark"
                                        value="{{ $order->lead->mobile_no }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center mt-4">
                            ...
                            <div class="col-lg-10 text-center">
                                <div class="form-group d-flex flex-wrap gap-3">
                                    @php
                                        $images = explode(',', $order->lead->site_image);
                                    @endphp
                                    @if (!empty($images))
                        ...
                        <div class="row align-items-center mt-4">
                            ...
                            <div class="col-lg-10 text-center">
                                <div class="form-group d-flex flex-wrap gap-3">
                                    @php
                                        $images = explode(',', $order->lead->design_attachment);
                                    @endphp
                                    @if (!empty($images))
                                        @foreach ($images as $image)
                                            <div class="text-center">
                        ...
                        <div class="row align-items-center mt-4">
                            ...
                            <div class="col-lg-10 text-center">
                                <div class="form-group d-flex flex-wrap gap-3">
                                    @php
                                        $images = explode(',', $order->lead->reference_image);
                                    @endphp
                                    @if (!empty($images))
                                        @foreach ($images as $image)
                                            <div class="text-center">
